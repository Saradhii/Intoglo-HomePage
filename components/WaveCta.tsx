      ...
      <CtaWrapper id="contact">
        <Container>
          ...
          <Description className="text-center">
            ...
            <div className="flex justify-between items-center mt-6 mb-5   w-[60%] sm:w-[30%] md:w-[30%]  lg:w-[25%] m-auto ">
              ...
              <div className="w-[85%] text-left">
                <a href="tel:+918469708714" className="tracking-wider font-normal">
                  +91-8469708714
                </a>
              </div>
            </div>
            <div className="flex justify-between items-center m-auto  w-[60%] sm:w-[30%] md:w-[30%] lg:w-[25%] ">
              <div className="w-[15%] text-left">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <div className="w-[85%] text-left">
                <a href="mailto:contact@intoglo.com" className="tracking-wider font-normal">
                  contact@intoglo.com
                </a>
              </div>
            </div>
